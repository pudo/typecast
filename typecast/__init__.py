...
def instances():
    """Yield a set of possible configurations for the various types.

    This can be used to perform type-guessing by checking the applicability
    of each converter against a set of sample data.
    """
